function addBubble (node) {
    ...
    circle = g.append('circle')
        ...
        .attr('r', (d) => d.r)
        .on('mouseenter', (d) => acd3.unmuteOnMouseEnter.call(this, d.data))
        .on('mouseleave', (d) => acd3.muteOnMouseLeave.call(this, d.data))
        .on('click', (d) => acd3.handleSingleClick.call(this, d.data))
        .on('dblclick', (d, i) => {
            if (this.config.onDoubleClick === 'openNewWindow') acd3.openNewWindow.call(this, d.data);
            else if (this.config.onDoubleClick === 'expandBubble') acd3.expandBubble.call(this, d.data, i);
        });
